...
export default class {
  ...
  handleClickIconEye = (icon) => {
    ...
    const modaleFile = this.document.querySelector('#modaleFile')
    ...
    modaleFile.addEventListener('shown.bs.modal', () => {
      ...
      modaleFile.querySelector(".modal-body").innerHTML = `<div style='text-align: center;' class="bill-proof-container"><img width=${imgWidth} src=${billUrl} alt="Bill" /></div>`
    }, { once: true })
